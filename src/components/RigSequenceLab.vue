...
import LayeredCharacterPreview from '@/components/LayeredCharacterPreview.vue'
...
const renderedFaceSvg = computed(() => renderedFrame.value.faceSvg)
  ...
  <section class="sequence-lab" aria-label="Multi-expression rig sequencer">
    ...
    <div class="layout">
      <div class="preview-panel">
        <LayeredCharacterPreview
          class="stage"
          :face-svg="renderedFaceSvg"
          :compatibility-svg="renderedSvg"
          :hair-id="hairId"
          :hair-placement="hairPlacement"
          :accessory-id="accessoryId"
          :accessory-placement="accessoryPlacement"
        />
